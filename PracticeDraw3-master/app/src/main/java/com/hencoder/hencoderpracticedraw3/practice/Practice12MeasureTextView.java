...
public class Practice12MeasureTextView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float spacing = paint1.measureText(text1);
        float spacint1 = paint2.measureText(text2);
        canvas.drawText(text1, 50, 200, paint1);
        canvas.drawText(text2, 50 + spacing, 200, paint2);
        canvas.drawText(text3, 50 + spacing + spacint1, 200, paint1);
    }
}
